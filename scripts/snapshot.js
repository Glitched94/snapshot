...
function mySnapshotItemsWrapper() {
  ...
  }, itemMappings = new Map([].concat(_toConsumableArray(foldable($item(_templateObject || (_templateObject = _taggedTemplateLiteral2(["liar's pants"]))))), _toConsumableArray(foldable($item(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral2(["ice pick"]))))), _toConsumableArray(manyToOne($item(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral2(["Spooky Putty sheet"]))), [$item(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral2(["Spooky Putty monster"])))].concat(_toConsumableArray(getFoldGroup($item(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral2(["Spooky Putty sheet"])))))))), _toConsumableArray(foldable($item(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral2(["stinky cheese sword"]))))), _toConsumableArray(foldable($item(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral2(["naughty paper shuriken"]))))), _toConsumableArray(foldable($item(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral2(["Loathing Legion knife"]))))), _toConsumableArray(foldable($item(_templateObject92 || (_templateObject92 = _taggedTemplateLiteral2(["deceased crimbo tree"]))))), _toConsumableArray(foldable($item(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral2(["makeshift turban"]))))), _toConsumableArray(foldable($item(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral2(["turtle wax shield"]))))), _toConsumableArray(foldable($item(_templateObject122 || (_templateObject122 = _taggedTemplateLiteral2(["metallic foil bow"]))))), _toConsumableArray(foldable($item(_templateObject132 || (_templateObject132 = _taggedTemplateLiteral2(["ironic moustache"]))))), _toConsumableArray(foldable($item(_templateObject142 || (_templateObject142 = _taggedTemplateLiteral2(["bugged balaclava"]))))), _toConsumableArray(foldable($item(_templateObject152 || (_templateObject152 = _taggedTemplateLiteral2(["toggle switch (Bartend)"]))))), _toConsumableArray(foldable($item(_templateObject162 || (_templateObject162 = _taggedTemplateLiteral2(["mushroom cap"]))))), _toConsumableArray(manyToOne($item(_templateObject172 || (_templateObject172 = _taggedTemplateLiteral2(["can of Rain-Doh"]))), $items(_templateObject182 || (_templateObject182 = _taggedTemplateLiteral2(["empty Rain-Doh can"]))))), _toConsumableArray(manyToOne($item(_templateObject192 || (_templateObject192 = _taggedTemplateLiteral2(["meteorite fragment"]))), $items(_templateObject202 || (_templateObject202 = _taggedTemplateLiteral2(["meteorite earring, meteorite necklace, meteorite ring"]))))), _toConsumableArray(manyToOne($item(_templateObject212 || (_templateObject212 = _taggedTemplateLiteral2(["Sneaky Pete's leather jacket"]))), $items(_templateObject222 || (_templateObject222 = _taggedTemplateLiteral2(["Sneaky Pete's leather jacket (collar popped)"]))))), _toConsumableArray(manyToOne($item(_templateObject232 || (_templateObject232 = _taggedTemplateLiteral2(["Boris's Helm"]))), $items(_templateObject242 || (_templateObject242 = _taggedTemplateLiteral2(["Boris's Helm (askew)"]))))), _toConsumableArray(manyToOne($item(_templateObject252 || (_templateObject252 = _taggedTemplateLiteral2(["Jarlsberg's pan"]))), $items(_templateObject262 || (_templateObject262 = _taggedTemplateLiteral2(["Jarlsberg's pan (Cosmic portal mode)"]))))), _toConsumableArray(manyToOne($item(_templateObject272 || (_templateObject272 = _taggedTemplateLiteral2(["tiny plastic sword"]))), $items(_templateObject282 || (_templateObject282 = _taggedTemplateLiteral2(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), _toConsumableArray(manyToOne($item(_templateObject292 || (_templateObject292 = _taggedTemplateLiteral2(["earthenware muffin tin"]))), $items(_templateObject302 || (_templateObject302 = _taggedTemplateLiteral2(["blueberry muffin, bran muffin, chocolate chip muffin"]))))), _toConsumableArray(manyToOne($item(_templateObject312 || (_templateObject312 = _taggedTemplateLiteral2(["ChibiBuddy\u2122 (on)"]))), $items(_templateObject322 || (_templateObject322 = _taggedTemplateLiteral2(["ChibiBuddy\u2122 (off)"]))))))), inventory = /* @__PURE__ */ new Map(), invLocations = inventoryOnly ? [import_kolmafia3.getInventory] : [import_kolmafia3.getInventory, import_kolmafia3.getCloset, import_kolmafia3.getDisplay, import_kolmafia3.getStorage], _i = 0, _invLocations = invLocations; _i < _invLocations.length; _i++)
  ...
  for (var _i3 = 0, _Object$entries2 = Object.entries((0, import_kolmafia3.getCampground)()); _i3 < _Object$entries2.length; _i3++) {
    ...
    if (_item2 !== $item(_templateObject332 || (_templateObject332 = _taggedTemplateLiteral2(["big rock"])))) {
